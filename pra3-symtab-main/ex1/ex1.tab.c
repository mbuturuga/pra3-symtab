...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_composite_formula = 25,         /* composite_formula  */
  YYSYMBOL_aux_scope = 26,                 /* aux_scope  */
...
{
       0,    80,    80,    81,    84,    85,    88,    89,    90,    95,
     114,   127,   128,   132,   133,   134,   135,   136,   137,   138,
     139,   142,   156,   175,   178,   179,   182,   192,   193
};
#endif
...
static const char *const yytname[] =
{
  ...
  "aux_end_all_scopes", "aux_end_scope", "formula", "composite_formula",
  "aux_scope", "aux_var", "atomic_formula", "term_list", "term", YY_NULLPTR
};
...
{
      15,    -8,   -14,    10,    34,   -14,    39,   -14,   -14,   -14,
       6,   -14,   -14,    39,    39,    -5,   -14,   -14,   -14,    21,
      25,    28,   -14,    43,    39,    39,    39,    39,   -14,   -14,
     -14,    23,     1,   -14,   -14,   -14,   -14,   -14,    31,    27,
      27,   -14,    21,   -14,    21,    39,    39,    46,   -14,    48,
      48,   -14,   -14,   -14
};
...
{
       0,     0,     6,     0,     0,     4,     0,     9,     1,     5,
       0,    21,    21,     0,     0,     0,    12,    11,     8,     0,
       0,     0,    15,     0,     0,     0,     0,     0,    21,    26,
      27,     0,     0,    24,    22,    22,    20,    16,    17,    18,
      19,     7,     0,    23,     0,     0,     0,     0,    25,    10,
      10,    28,    13,    14
};
...
{
      22,    23,    20,    21,    24,    25,     7,    26,    27,    28,
       8,    37,    38,    39,    40,    -3,     1,    43,    44,    41,
     -21,    19,   -21,   -21,    29,    30,   -21,    31,    34,     2,
     -21,    35,    49,    50,    -2,     1,    24,    25,    42,   -21,
      24,   -21,   -21,    53,    10,   -21,    11,    12,     2,   -21,
      13,     9,    24,    25,    14,    26,    27,    24,    25,    36,
      26,    27,    51,    44,    46,     0,    47,     0,     0,     0,
      48
};

static const yytype_int8 yycheck[] =
{
      13,    14,    11,    12,     9,    10,    14,    12,    13,    14,
       0,    24,    25,    26,    27,     0,     1,    16,    17,    28,
       5,    15,     7,     8,     3,     4,    11,     6,     3,    14,
      15,     3,    45,    46,     0,     1,     9,    10,    15,     5,
       9,     7,     8,    50,     5,    11,     7,     8,    14,    15,
      11,     4,     9,    10,    15,    12,    13,     9,    10,    16,
      12,    13,    16,    17,    35,    -1,    42,    -1,    -1,    -1,
      44
};
...
{
       0,     1,    14,    19,    20,    21,    26,    14,     0,    21,
       5,     7,     8,    11,    15,    24,    25,    28,    22,    15,
      26,    26,    24,    24,     9,    10,    12,    13,    14,     3,
       4,     6,    29,    30,     3,     3,    16,    24,    24,    24,
      24,    26,    15,    16,    17,    27,    27,    29,    30,    24,
      24,    16,    23,    23
};
...
#line 1195 "ex1.tab.c"
  ...
  case 7: /* sentence: aux_scope formula EOL aux_scope  */
#line 89 "ex1.y"
...
#line 1247 "ex1.tab.c"
  ...
  case 11: /* formula: atomic_formula  */
#line 127 "ex1.y"
                                { (yyval.string) = get_string("%s", (yyvsp[0].string)); free((yyvsp[0].string)); }
#line 1253 "ex1.tab.c"
    break;

  case 12: /* formula: composite_formula  */
#line 128 "ex1.y"
                                { (yyval.string) = get_string("%s", (yyvsp[0].string)); free((yyvsp[0].string)); }
#line 1259 "ex1.tab.c"
    break;

  case 13: /* composite_formula: FORALL aux_scope VAR aux_var formula aux_end_scope  */
#line 132 "ex1.y"
                                                                            { (yyval.string) = get_string("forall %s %s", (yyvsp[-3].name), (yyvsp[-1].string)); free((yyvsp[-3].name)); free((yyvsp[-1].string)); }
#line 1265 "ex1.tab.c"
    break;

  case 14: /* composite_formula: EXISTS aux_scope VAR aux_var formula aux_end_scope  */
#line 133 "ex1.y"
                                                                            { (yyval.string) = get_string("exists %s %s", (yyvsp[-3].name), (yyvsp[-1].string)); free((yyvsp[-3].name)); free((yyvsp[-1].string)); }
#line 1271 "ex1.tab.c"
    break;

  case 15: /* composite_formula: NOT formula  */
#line 134 "ex1.y"
                                            { (yyval.string) = get_string("!%s", (yyvsp[0].string)); free((yyvsp[0].string)); }
#line 1277 "ex1.tab.c"
    break;

  case 16: /* composite_formula: formula AND formula  */
#line 135 "ex1.y"
                                            { (yyval.string) = get_string("(%s and %s)", (yyvsp[-2].string), (yyvsp[0].string)); free((yyvsp[-2].string)); free((yyvsp[0].string)); }
#line 1283 "ex1.tab.c"
    break;

  case 17: /* composite_formula: formula OR formula  */
#line 136 "ex1.y"
                                            { (yyval.string) = get_string("(%s or %s)", (yyvsp[-2].string), (yyvsp[0].string)); free((yyvsp[-2].string)); free((yyvsp[0].string)); }
#line 1289 "ex1.tab.c"
    break;

  case 18: /* composite_formula: formula IMPLIES formula  */
#line 137 "ex1.y"
                                            { (yyval.string) = get_string("(%s -> %s)", (yyvsp[-2].string), (yyvsp[0].string)); free((yyvsp[-2].string)); free((yyvsp[0].string)); }
#line 1295 "ex1.tab.c"
    break;

  case 19: /* composite_formula: formula IFF formula  */
#line 138 "ex1.y"
                                            { (yyval.string) = get_string("(%s <-> %s)", (yyvsp[-2].string), (yyvsp[0].string)); free((yyvsp[-2].string)); free((yyvsp[0].string)); }
#line 1301 "ex1.tab.c"
    break;

  case 20: /* composite_formula: '(' formula ')'  */
#line 139 "ex1.y"
                                            { (yyval.string) = get_string("(%s)", (yyvsp[-1].string)); free((yyvsp[-1].string));}
#line 1307 "ex1.tab.c"
    break;

  case 21: /* aux_scope: %empty  */
#line 142 "ex1.y"
          { 
...
#line 156 "ex1.y"
    ...
    // Set the type content of the variable
    info.type = TVAR;
    info.arity = 0;

    if (sym_add(var_name, &info) == SYMTAB_DUPLICATE){
        fprintf(stderr, "SEMANTIC ERROR: Variable %s already declared. Line%d\n", var_name, nlin);
        error = 1;
        YYERROR;
        }
    else{
        printf("Added variable %s with type %d and arity %d\n", var_name, info.type, info.arity);
        }
    }
#line 1345 "ex1.tab.c"
    break;
